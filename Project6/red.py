...
for img in imageList:
    ...
    mser = cv2.MSER_create(_delta=10,_min_diversity = 0.2,_min_area=600,_max_area=1500,_max_variation=0.15)
    grayBlue =cDashBlue
    grayRed=cDashRed
    vis = firstImage.copy()
    ...
    #                         sign=skimage.io.imread('./data/Testing/00045/00318_00001.ppm')
    ...
    cv2.imwrite('./results/det_red/frame' + str(frno) + '.png',vis)
    # cv2.imshow('lol',vis)
