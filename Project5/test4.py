...
def main():
    ...
    for img,_ in enumerate(images[:-2]):
        ...
        # if (img%20)==0:
        #     print("if condn",img)
        #     file1 = './results/builtin10/iters'+str(img)+'.npy'
        ...
        linear = [rot_calc,trans_calc,points]
        if (img%20)==0:
            file2 = './results/linear11/iters'+str(img)+'.npy'
