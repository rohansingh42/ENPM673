...
def features(img1, img2):
    ...
    res = cv2.drawMatches(img1, kp1, img2, kp2, good, None)#, matches1to2[, outImg[, matchColor[, singlePointColor[, matchesMask[, flags]]]]])
    cv2.imshow('res',res)
    cv2.imwrite('./results/sift_features2.png',res)
    while True:
